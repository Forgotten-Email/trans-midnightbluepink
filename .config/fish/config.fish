if status is-interactive
    ...
    alias ncmpcpp-tmux='tmux new-session -s $fish_pid "tmux source-file $HOME/.config/ncmpcpp/tsession"'       
    alias ncmpcpp-ueberzug="$HOME/.config/ncmpcpp/ncmpcpp-ueberzug/ncmpcpp-ueberzug"
   colorscript -r
end
